...
<nav class="navbar navbar-inverse" >
  <div class="container-fluid" >
    <div class="navbar-header">
       <a class="navbar-brand" href="${pageContext.request.contextPath }/client/index.jsp" target="right">Keke Bookstore</a>		
    </div>
    <ul class="nav navbar-nav">
      <li></li>
      <li><a href="${pageContext.request.contextPath }/client/index.jsp" target="right">Foreground</a></li>
